...
WINDOWS_CACHE = CACHE_DIR / "_checkpoint_v15_windows.npz"
...
def add_v15_features(weekly: pd.DataFrame) -> pd.DataFrame:
    ...
    # Monat aus ordinal (ordinal = year*372 + month*31 + day)
...
def main() -> None:
    ...
    # Score-Lags: letzter bekannter Training-Score pro Region
